...
import type { RequestOptions, Result, UploadFileParams, UploadFileCallBack } from './type';
    ...
    uploadFile<T = any>(config: AxiosRequestConfig, params: UploadFileParams, callback?: UploadFileCallBack) {
        ...
        .then((res: any) => {
            ...
            if (res.data.success === true && res.data.code === 200) {
                void createMessage.success(res.data.message);
            } else {
                void createMessage.error(res.data.message);
            }
            }
        });
    }
        ...
        return new Promise((resolve, reject) => {
            ...
            if (transformRequestHook && isFunction(transformRequestHook)) {
                try {
                    ...
                    (config as any).success && (config as any).success(res.data);
                    resolve(ret);
                } catch (err) {
